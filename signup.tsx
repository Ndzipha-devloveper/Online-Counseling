    ...
    <Layout>
      <div className="min-h-screen flex items-center justify-center bg-background px-4 py-12">
        <div className="w-full max-w-lg">
          {/* Progress Steps */}
          <div className="bg-primary text-primary-foreground rounded-t-lg p-6 mb-0">
            <div className="flex justify-around items-center">
              <div className="text-center">
                <div className="w-12 h-12 rounded-full border-2 border-primary-foreground bg-primary flex items-center justify-center mx-auto mb-2">
              ...
              <div className="text-center">
                <div className="w-12 h-12 rounded-full border-2 border-primary-foreground bg-black flex items-center justify-center mx-auto mb-2">
